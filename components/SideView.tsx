...
import { boxPath, PhotoZone, PhotoZonePath } from './PhotoZonePath';
import {
  SavedPanelPath,
...
const sideZones: PhotoZone[] = [
  ...
  },
  {
    part: 'frontDoor',
    label: 'FRONT DOOR',
    d: 'M 78.0,69.2 L 44.9,69.5 L 46.3,62.9 L 46.6,57.0 L 45.9,50.9 L 44.9,46.3 L 57.1,46.3 L 67.6,47.0 L 76.1,47.8 L 80.0,47.8 L 80.2,55.3 L 80.0,61.9 Z',
  },
  {
    part: 'rearDoor',
    label: 'REAR DOOR',
    d: 'M 44.6,45.4 L 11.7,44.5 L 10.7,45.9 L 11.0,49.6 L 11.7,53.0 L 12.7,53.7 L 16.1,55.0 L 18.0,56.7 L 19.0,58.1 L 19.8,59.1 L 20.7,61.3 L 22.2,64.5 L 23.4,68.1 L 44.1,69.1 L 46.6,63.7 L 47.3,58.9 L 46.1,50.6 Z',
  },
  {
    part: 'sideSkirt',
    label: 'SIDE SKIRT',
    d: 'M 22.7,69.7 L 22.0,72.6 L 71.5,74.1 L 82.2,73.6 L 82.9,70.4 L 63.9,69.5 L 31.2,69.5 Z',
  },
  {
  ...
  { part: 'leftMirror', label: 'MIRROR', d: boxPath(63, 25, 9, 10) },
  {
    part: 'leftAPillar',
    label: 'LEFT A-PILLAR',
    d: 'M 48.0,45.4 L 41.5,44.7 L 40.5,32.5 L 45.1,32.3 Z',
  },
  {
    part: 'leftBPillar',
    label: 'DOOR B-PILLAR',
